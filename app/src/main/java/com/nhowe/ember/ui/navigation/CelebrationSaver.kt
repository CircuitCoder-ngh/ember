...
val CelebrationSaver: Saver<CelebrationEvent?, String> = Saver(
    save = { e ->
        when (e) {
            ...
            is CelebrationEvent.ProgramGraduated -> "program|${e.programId}|${e.title}|${e.badgeTitle}|${e.badgeIcon}|${e.xp}|${e.nextTemplateId ?: ""}"
    ...
    restore = { s ->
        ...
        when (parts.firstOrNull()) {
            ...
            "program" -> CelebrationEvent.ProgramGraduated(parts[1], parts[2], parts[3], parts[4], parts[5].toInt(), parts[6].ifEmpty { null })
